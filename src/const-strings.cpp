...
const char* kStrTimestamp = "timestamp";
const char* kStrCollected   = "collected";
const char* kStrLocationX   = "location_x";
const char* kStrLocationY   = "location_y";
const char* kStrOrigImageWidth  = "orig_image_width";
const char* kStrOrigImageHeight = "orig_image_height";
const char* kStrObjectId    = "object_id";
const char* kStrStreamType  = "stream_type";
const char* kStrForeground  = "foreground";
const char* kStrOBJECT_STREAM = "OBJECT_STREAM";
